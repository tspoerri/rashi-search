...
**Next action:** Decide whether to tackle term-rarity ranking (see "Calibration round 1" below) as part of the vowels/prefixes rework, or leave it. Run more calibration rounds if useful: `node scripts/sample-rashis.mjs 10 --seed 2 --spread` (bump the seed each round).
